...
const Banner = () => {
  return (
    <div className="w-full  mt-20 md:h-[400px] h-[800px] bg-black relative flex items-center justify-center gap-3 lg:px-0 px-5">
			<img
				src={banner1}
				alt="banner1"
				className="absolute top-0 left-0 w-full h-full z-[50]"
			/>
			<div className="flex items-start gap-6 lg:flex-row flex-col px-8">
				<img
					src={comma}
					alt="comma"
					className="z-[100]"
