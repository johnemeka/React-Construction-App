...
const Features = () => {
  ...
  return (
    <div id='services' className="w-full flex lg:flex-row flex-col items-center justify-between lg:mt-20 mt-20 lg:px-40 px-5 lg:gap-6 gap-12">
			{features.map((feature) => (
				...
				>
					<img
						...
						className="w-[71px]"
					/>
					<span className="text-secondary font-Fira text-[24px] font-bold">
						{feature.title}
					</span>
					<p className="text-lightText font-Urbanist text-[16px] max-w-[400px] lg:text-left text-center">
						{feature.description}
					</p>
